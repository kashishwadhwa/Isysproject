                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a class="collapsed" data-toggle="collapse" href="#togglePages"><i class="menu-icon icon-cog"></i><i class="icon-chevron-down pull-right"></i><i class="icon-chevron-up pull-right"></i>Settings </a>
                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="#" class="btn-box big span4"><i class="icon-money"></i><b>
                                        <asp:Label runat="server" ID="lbl_balance"></asp:Label></b>
                                        <p class="text-muted">
                                            Balance
                                        </p>
                                    </a><a href="#" class="btn-box big span4"><i class="icon-user"></i><b>
                                        <asp:Label runat="server" ID="lbl_amount"></asp:Label></b>
                                        <p class="text-muted">
                                            Amount Paid
                                        </p>
                                    </a><a href="#" class="btn-box big span4"><i class=" icon-random"></i><b>
                                        <asp:Label runat="server" ID="lbl_lastVisit"></asp:Label></b>
                                        <p class="text-muted">
                                            Last Visit
                                        </p>
                                    </a>
